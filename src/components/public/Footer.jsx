...
import { FaFacebookF, FaInstagram, FaSnapchatGhost, FaTwitter ,FaMobileAlt } from "react-icons/fa";
...
const Footer = () => {
        ...
        <div>
          ...
          <ul className="space-y-2">
            {["Contact Us", "Track Order", "Returns & Refunds", "FAQs", "My Account"].map((item) => (
              <li key={item} className="hover:underline cursor-pointer hover:text-red-500">
                {item}
              </li>
            ))}
          </ul>
  ...
  30 Days Easy Returns & Exchanges
        ...
        <div>
          ...
          <ul className="space-y-2">
            {["About Us", "Investor Relation", "Careers", "Gift Vouchers", "Community Initiatives"].map((item) => (
              <li key={item} className="hover:underline cursor-pointer  hover:text-red-500">
                {item}
              </li>
            ))}
        ...
        <div>
          ...
          <ul className="space-y-2">
            {["T&C", "Privacy Policy", "Sitemap", "Get Notified", "Blogs"].map((item) => (
              <li key={item} className="hover:underline cursor-pointer hover:text-red-500">
                {item}
              </li>
            ))}
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li className="text-blue-700 font-semibold cursor-pointer">View More</li>
          </ul>
        </div>
      </div>
